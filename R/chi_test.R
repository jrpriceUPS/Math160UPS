...
chi_test <- function(){
  cat("Are you executing a chi-squared test of independence or a goodness of fit test?\nPossible answers are 'independence' and 'goodness'.\n")
  compare = readline()
  while(!(compare %in% c("independence","goodness"))){
    cat("Please answer either 'independence' or 'goodness'.\n")
    compare = readline()
  }

  if(compare=="independence"){
